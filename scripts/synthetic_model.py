...
yri_fitcoal_esfs = 826650000*1.2e-8*compute_expected_sfs(216, yri_fitcoal_change_points, yri_fitcoal_sizes)

ksfs = mushi.kSFS(yri_fitcoal_esfs)
...
synthetic_esfs = 826650000*1.2e-8*compute_expected_sfs(216, ksfs.eta.change_points, ksfs.eta.y)
